...
public class VendingMachineImpl implements VendingMachine {   
   ...
   @Override
    public long selectItemAndGetPrice(Item item) throws SoldOutException {
        ...
        if(itemInventory.hasItem(item)){
            currentItem = item; 
       	 System.out.println("Item " + item + " is selected with price " + currentItem.getPrice());
   ...
   public void insertCoin(Coin coin) {
       ...
       System.out.println("Current cash input amount " + currentBalance);
   }
    ...
    private List<Coin> collectChange() {
        ...
        System.out.println("Current item price " + currentItem.getPrice());
